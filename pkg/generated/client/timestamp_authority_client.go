...
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *TimestampAuthority {
	// ensure nullable parameters have default
	if formats == nil {
...
func (c *TimestampAuthority) SetTransport(transport runtime.ContextualTransport) {
